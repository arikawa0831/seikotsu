    ...
    <div class="l-under-main">
      <div class="l-under-main__grid">
        <div class="l-under-main__texts">
          <h1>
            <span>NEWS</span><br>
            <span><?php echo get_post_time( 'Y年' ); ?><br><?php echo esc_html(get_post_type_object(get_post_type())->label); ?></span>
          </h1>
        </div>
  ...
  <div class="p-news__pagenavi">
    <div class="l-pagenavi">
      <div class="l-pagenavi__grid">
        ...
        <span class="l-pagenavi__now"><?php echo get_post_time( 'Y年' ); ?><?php echo esc_html(get_post_type_object(get_post_type())->label); ?></span>
      </div>
    </div>
  </div>
